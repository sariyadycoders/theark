defmodule TheArkWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-zinc-50/90 fixed transition-opacity" aria-hidden="true" />
      <div
  ...
  def input(assigns) do
    ~H"""
    <div phx-feedback-for={@name} class={if @input_class, do: @input_class, else: "mt-2"}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TheArkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TheArkWeb.Gettext, "errors", msg, opts)
    end
  end
